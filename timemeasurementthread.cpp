...
#include "./algoritmi_studentski_projekti/ga_shortest_path_tree.h"
...
void TimeMeasurementThread::run()
{
    ...
    for(int i= _minValue; i <= _maxValue; i += _step)
    {
        ...
        case TipAlgoritma::TRIANGULACIJA:
            ...
            break;
        case TipAlgoritma::SHORTEST_PATH_TREE:
            pAlgorithm = new UnweightedShortestPathTree(nullptr, 0, false, "", i);
            break;
        default:
            break;
        }
